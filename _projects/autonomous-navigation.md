...
<div class="row justify-content-center">
  <div class="col-sm-12 col-md-6 mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/projects/autonomous-navigation/images/robot-simulation.png" title="TurtleBot3 Simulation" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
...
<div class="row justify-content-center">
  <div class="col-sm-12 col-md-6 mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/projects/autonomous-navigation/images/robot-testing.png" title="TurtleBot3 Testing" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
...
<div class="row justify-content-center">
  <div class="col-sm-12 col-md-6 mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/projects/autonomous-navigation/images/turtlebot4.png" title="TurtleBot4" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
