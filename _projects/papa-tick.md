...
<div class="row justify-content-center">
  <div class="col-sm-12 col-md-6 mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/projects/papa-tick/images/tick-elimination-test.jpg" title="Tick Elimination" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/projects/papa-tick/images/prototype.jpg" title="Papa Tick 3D" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/projects/papa-tick/images/fieldwork.jpg" title="Fieldwork with Biologists" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
